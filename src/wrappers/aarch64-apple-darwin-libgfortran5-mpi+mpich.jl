# Autogenerated wrapper script for TDEP_jll for aarch64-apple-darwin-libgfortran5-mpi+mpich
...
function __init__()
    JLLWrappers.@generate_init_header(HDF5_jll, FFTW_jll, OpenBLAS32_jll, CompilerSupportLibraries_jll, MPICH_jll, MPIPreferences)
